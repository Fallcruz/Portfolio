...
function Navbar() {
    ...
    return (
        <nav className='flex flex-row items-center justify-between fixed top-0 left-0 right-0 lg:py-3 py-2 lg:px-14 px-6 bg-black-secondary/60 backdrop-blur-lg z-50 max-w-[1600px] mx-auto'>
            ...
            <ul className={`navbar-menu ${showNavbar ? 'flex' : 'hidden'} lg:flex flex-row lg:w-fit w-[98%] lg:bg-[#ffffff00] bg-black-secondary items-center lg:justify-end justify-center lg:pt-0 lg:pb-0 pt-4 pb-6 lg:gap-8 gap-2`}>
